<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <div class="d-flex align-items-stretch">
     ...
     <li><a href="#exampleg" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows"></i>Product</a>
            <ul id="exampleg" class="collapse list-unstyled ">
         ...
         <li><a href="#exampled" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows"></i>Category</a>
            <ul id="exampled" class="collapse list-unstyled ">
          ...
          <li><a href="#examplef" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows"></i>Supplier</a>
            <ul id="examplef" class="collapse list-unstyled ">
          ...
          <div class="container-fluid">
            ...
            <div class="col-lg-12">
                <div class="block text-center">
                 <p class="details"><a href="adminsupplier" class="text-white"><i class="fa fa-plus text-left  rounded-circle  p-2 border border-white"></i></a></p>
  ...
  <strong>Supplier Not Deleted!</strong> 
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
</div>
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
	...
	<%   
            	   ...
            	   %>
                  <div class="title"><strong>Supplier Details</strong></div>
    ...
    <c:forEach items="${supplierList}" var="supplier" >
           ...
           <a href="${pageContext.request.contextPath}/updateSupplier/${supplier.supplierId}" class="btn btn-secondary ">
	       <i class="fa fa-edit"></i>
           </a>

           <a href="${pageContext.request.contextPath}/deleteSupplier/${supplier.supplierId}" class="btn btn-secondary " onclick="return confirm('Are you sure you want to delete this item?');">
